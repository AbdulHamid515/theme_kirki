   ...
   <?php
if (get_theme_mod('works_show',true)==true) {?>
 <section id="portfolios" class="section-padding">
      <!-- Container Starts -->
      <div class="container">
        <div class="section-header text-center">
          <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s"><?php echo get_theme_mod('works_heading');?></h2>
          <p><?php echo get_theme_mod('works_desc');?></p>
        </div>
